...
import com.carloosx.gesturerecorder.adapter.ColorsAdapter;
import com.carloosx.gesturerecorder.dialogs.DialogResultListener;
import com.carloosx.gesturerecorder.dialogs.PromptDialog;
import com.carloosx.gesturerecorder.settings.AppSettings;
import com.carloosx.gesturerecorder.utils.Label;
import com.carloosx.gesturerecorder.utils.TimestampAxisFormatter;
import com.carloosx.gesturerecorder.utils.Utils;
...
public class MainActivity extends AppCompatActivity implements DialogResultListener {
    ...
    private static final int[] LINE_COLORS = {0xFFFF5252, 0xFF33D9B2, 0xFF34ACE0};
    ...
    private void initViews() {
        ...
        xAxis.setGridColor(Color.parseColor("#8016a085"));
        ...
        rightAxis.setGridColor(Color.parseColor("#8016a085"));
    }
    ...
    private boolean isSampleSelected() {
        ...
        return getLineData().getDataSetByIndex(0).getEntryCount() - selectedEntryIndex >= GESTURE_SAMPLES;
    }
    ...
    private void loadDataToast(String file) {
        try {
            ...
            fileNameTimestamp = data.first.timestamp;
